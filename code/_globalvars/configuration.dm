...
GLOBAL_VAR_INIT(game_version, "Crimson Grid") // DARKPACK EDIT CHANGE - ORIGINAL: GLOBAL_VAR_INIT(game_version, "/tg/Station 13") // CRIMSON EDIT CHANGE - ORIGINAL: GLOBAL_VAR_INIT(game_version, "DarkPack: Second City")
